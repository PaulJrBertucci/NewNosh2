...
return [
    ...
    */
    ...
    "invite_title" => "Accept your invitation to access iTriage EMR",
    ...
    // Email
    "api_provider_register1" => "This message is sent to you from one of your patients who has an iTriage EMR electronic health record system.",
    ...
    "api_uma_register2" => ", who has an iTriage EMR electronic health record system.",
