    ...
    protected function generate_pdf($html, $filepath, $footer='footerpdf', $header='', $type='1', $headerparam='', $watermark='')
    {
        ...
        PDF::setFooterCallback(function($pdf) use ($footer) {
            ...
            if ($footer == 'footerpdf') {
                ...
                $footer_html .= '<p style="text-align:center; font-size: 8px;">This document was generated by iTriage EMR</p>';
            }
        ...
        PDF::SetAuthor('iTriage EMR');
        PDF::SetTitle('iTriage PDF Document');
        if ($type == '1') {
